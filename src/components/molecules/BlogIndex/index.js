      ...
      <div className="mt-10">
        ...
        >
          {currentBlogs.map((blog) => {
            const { _id, title, date, img, description, path, link } = blog;
            return (
              <div
                key={_id}
                className="flex flex-col w-full items-center justify-between gap-8 rounded-lg min-h-32 cursor-pointer"
              >
