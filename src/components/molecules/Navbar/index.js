...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { title: "Blogs", link: "/blog", icon: <ImBlog /> },
  ];
  const activeLink = ({ isActive }) => {
    return {
      fontWeight: 500,
      color: isActive && "#ffad09f7",
    };
  };
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Mahima Sharma</h1>
          </Link>
        </div>
        <div>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2023, Mahima Sharma. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
