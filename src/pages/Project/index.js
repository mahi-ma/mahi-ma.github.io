            ...
            {items.map((item, i) => (
              <Link key={i} to={`/project/${item.id}`}>
                <motion.div
                  ...
                  key={item.id}
                  className="item-container cursor-pointer rounded-lg shadow-lg p-3 flex flex-col justify-between hover:shadow-primary duration-500"
                ...
                >
                  <div className="item h-full">
                    ...
                    />
                    <img
                      className="mask-img absolute bottom-0 left-0"
                      src="mask.png"
                      alt="Mask Image"
                    />
                    <h3 className="absolute bottom-6 left-6 font-bold text-xl">{item.title}</h3>
                  </div>
                </motion.div>
              </Link>
            ))}
